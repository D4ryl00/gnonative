...
public struct Land_Gno_Gnomobile_V1_GetRemoteRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Land_Gno_Gnomobile_V1_GetRemoteResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Land_Gno_Gnomobile_V1_GetChainIDRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Land_Gno_Gnomobile_V1_GetChainIDResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Land_Gno_Gnomobile_V1_HasKeyByNameRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Land_Gno_Gnomobile_V1_HasKeyByNameResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var has: Bool = false
...
public struct Land_Gno_Gnomobile_V1_HasKeyByAddressRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Land_Gno_Gnomobile_V1_HasKeyByAddressResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Land_Gno_Gnomobile_V1_HasKeyByNameOrAddressRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Land_Gno_Gnomobile_V1_HasKeyByNameOrAddressResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Land_Gno_Gnomobile_V1_GetKeyInfoByNameRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Land_Gno_Gnomobile_V1_GetKeyInfoByNameResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Land_Gno_Gnomobile_V1_GetKeyInfoByAddressRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Land_Gno_Gnomobile_V1_GetKeyInfoByAddressResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Land_Gno_Gnomobile_V1_GetKeyInfoByNameOrAddressRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Land_Gno_Gnomobile_V1_GetKeyInfoByNameOrAddressResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Land_Gno_Gnomobile_V1_GetRemoteRequest: @unchecked Sendable {}
extension Land_Gno_Gnomobile_V1_GetRemoteResponse: @unchecked Sendable {}
...
extension Land_Gno_Gnomobile_V1_GetChainIDRequest: @unchecked Sendable {}
extension Land_Gno_Gnomobile_V1_GetChainIDResponse: @unchecked Sendable {}
...
extension Land_Gno_Gnomobile_V1_HasKeyByNameRequest: @unchecked Sendable {}
extension Land_Gno_Gnomobile_V1_HasKeyByNameResponse: @unchecked Sendable {}
extension Land_Gno_Gnomobile_V1_HasKeyByAddressRequest: @unchecked Sendable {}
extension Land_Gno_Gnomobile_V1_HasKeyByAddressResponse: @unchecked Sendable {}
extension Land_Gno_Gnomobile_V1_HasKeyByNameOrAddressRequest: @unchecked Sendable {}
extension Land_Gno_Gnomobile_V1_HasKeyByNameOrAddressResponse: @unchecked Sendable {}
extension Land_Gno_Gnomobile_V1_GetKeyInfoByNameRequest: @unchecked Sendable {}
extension Land_Gno_Gnomobile_V1_GetKeyInfoByNameResponse: @unchecked Sendable {}
extension Land_Gno_Gnomobile_V1_GetKeyInfoByAddressRequest: @unchecked Sendable {}
extension Land_Gno_Gnomobile_V1_GetKeyInfoByAddressResponse: @unchecked Sendable {}
extension Land_Gno_Gnomobile_V1_GetKeyInfoByNameOrAddressRequest: @unchecked Sendable {}
extension Land_Gno_Gnomobile_V1_GetKeyInfoByNameOrAddressResponse: @unchecked Sendable {}
...
extension Land_Gno_Gnomobile_V1_GetRemoteRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".GetRemoteRequest"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  public static func ==(lhs: Land_Gno_Gnomobile_V1_GetRemoteRequest, rhs: Land_Gno_Gnomobile_V1_GetRemoteRequest) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Land_Gno_Gnomobile_V1_GetRemoteResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".GetRemoteResponse"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "remote"),
  ]
  ...
  public static func ==(lhs: Land_Gno_Gnomobile_V1_GetRemoteResponse, rhs: Land_Gno_Gnomobile_V1_GetRemoteResponse) -> Bool {
    if lhs.remote != rhs.remote {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Land_Gno_Gnomobile_V1_GetChainIDRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".GetChainIDRequest"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  public static func ==(lhs: Land_Gno_Gnomobile_V1_GetChainIDRequest, rhs: Land_Gno_Gnomobile_V1_GetChainIDRequest) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Land_Gno_Gnomobile_V1_GetChainIDResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".GetChainIDResponse"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "chain_id"),
  ]
  ...
  public static func ==(lhs: Land_Gno_Gnomobile_V1_GetChainIDResponse, rhs: Land_Gno_Gnomobile_V1_GetChainIDResponse) -> Bool {
    if lhs.chainID != rhs.chainID {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Land_Gno_Gnomobile_V1_ListKeyInfoResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .unique(proto: "keys", json: "key_info"),
  ]
...
extension Land_Gno_Gnomobile_V1_HasKeyByNameRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".HasKeyByNameRequest"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "name"),
  ]
  ...
  public static func ==(lhs: Land_Gno_Gnomobile_V1_HasKeyByNameRequest, rhs: Land_Gno_Gnomobile_V1_HasKeyByNameRequest) -> Bool {
    if lhs.name != rhs.name {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Land_Gno_Gnomobile_V1_HasKeyByNameResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".HasKeyByNameResponse"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "has"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularBoolField(value: &self.has) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if self.has != false {
      try visitor.visitSingularBoolField(value: self.has, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Land_Gno_Gnomobile_V1_HasKeyByNameResponse, rhs: Land_Gno_Gnomobile_V1_HasKeyByNameResponse) -> Bool {
    if lhs.has != rhs.has {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Land_Gno_Gnomobile_V1_HasKeyByAddressRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".HasKeyByAddressRequest"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "address"),
  ]
  ...
  public static func ==(lhs: Land_Gno_Gnomobile_V1_HasKeyByAddressRequest, rhs: Land_Gno_Gnomobile_V1_HasKeyByAddressRequest) -> Bool {
    if lhs.address != rhs.address {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Land_Gno_Gnomobile_V1_HasKeyByAddressResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".HasKeyByAddressResponse"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "has"),
  ]
  ...
  public static func ==(lhs: Land_Gno_Gnomobile_V1_HasKeyByAddressResponse, rhs: Land_Gno_Gnomobile_V1_HasKeyByAddressResponse) -> Bool {
    if lhs.has != rhs.has {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Land_Gno_Gnomobile_V1_HasKeyByNameOrAddressRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".HasKeyByNameOrAddressRequest"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Land_Gno_Gnomobile_V1_HasKeyByNameOrAddressRequest, rhs: Land_Gno_Gnomobile_V1_HasKeyByNameOrAddressRequest) -> Bool {
...
extension Land_Gno_Gnomobile_V1_HasKeyByNameOrAddressResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".HasKeyByNameOrAddressResponse"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "has"),
  ]
  ...
  public static func ==(lhs: Land_Gno_Gnomobile_V1_HasKeyByNameOrAddressResponse, rhs: Land_Gno_Gnomobile_V1_HasKeyByNameOrAddressResponse) -> Bool {
    if lhs.has != rhs.has {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Land_Gno_Gnomobile_V1_GetKeyInfoByNameRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".GetKeyInfoByNameRequest"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "name"),
  ]
  ...
  public static func ==(lhs: Land_Gno_Gnomobile_V1_GetKeyInfoByNameRequest, rhs: Land_Gno_Gnomobile_V1_GetKeyInfoByNameRequest) -> Bool {
    if lhs.name != rhs.name {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Land_Gno_Gnomobile_V1_GetKeyInfoByNameResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".GetKeyInfoByNameResponse"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .unique(proto: "key", json: "key_info"),
  ]
  ...
  public static func ==(lhs: Land_Gno_Gnomobile_V1_GetKeyInfoByNameResponse, rhs: Land_Gno_Gnomobile_V1_GetKeyInfoByNameResponse) -> Bool {
...
extension Land_Gno_Gnomobile_V1_GetKeyInfoByAddressRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".GetKeyInfoByAddressRequest"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "address"),
  ]
  ...
  public static func ==(lhs: Land_Gno_Gnomobile_V1_GetKeyInfoByAddressRequest, rhs: Land_Gno_Gnomobile_V1_GetKeyInfoByAddressRequest) -> Bool {
    if lhs.address != rhs.address {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Land_Gno_Gnomobile_V1_GetKeyInfoByAddressResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".GetKeyInfoByAddressResponse"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .unique(proto: "key", json: "key_info"),
  ]
  ...
  public static func ==(lhs: Land_Gno_Gnomobile_V1_GetKeyInfoByAddressResponse, rhs: Land_Gno_Gnomobile_V1_GetKeyInfoByAddressResponse) -> Bool {
    if lhs._key != rhs._key {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Land_Gno_Gnomobile_V1_GetKeyInfoByNameOrAddressRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".GetKeyInfoByNameOrAddressRequest"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "name_or_bech32"),
  ]
  ...
  public static func ==(lhs: Land_Gno_Gnomobile_V1_GetKeyInfoByNameOrAddressRequest, rhs: Land_Gno_Gnomobile_V1_GetKeyInfoByNameOrAddressRequest) -> Bool {
    if lhs.nameOrBech32 != rhs.nameOrBech32 {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Land_Gno_Gnomobile_V1_GetKeyInfoByNameOrAddressResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".GetKeyInfoByNameOrAddressResponse"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .unique(proto: "key", json: "key_info"),
  ]
  ...
  public static func ==(lhs: Land_Gno_Gnomobile_V1_GetKeyInfoByNameOrAddressResponse, rhs: Land_Gno_Gnomobile_V1_GetKeyInfoByNameOrAddressResponse) -> Bool {
    if lhs._key != rhs._key {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Land_Gno_Gnomobile_V1_SelectAccountResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularMessageField(value: &self._key) }()
      case 2: try { try decoder.decodeSingularBoolField(value: &self.hasPassword_p) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.hasPassword_p != false {
      try visitor.visitSingularBoolField(value: self.hasPassword_p, fieldNumber: 2)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
...
extension Land_Gno_Gnomobile_V1_HelloResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .unique(proto: "greeting", json: "Greeting"),
  ]
